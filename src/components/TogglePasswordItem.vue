...
<template>
  <div class="space-y-5" data-hs-toggle-password-group>
    <div class="max-w-sm">
      <label :for="`hs-toggle-password-${groupId}-np`" class="block text-sm mb-2 dark:text-white">
        New password
      </label>
      <div class="relative">
        <input
    ...
    <div class="max-w-sm">
      <label :for="`hs-toggle-password-${groupId}`" class="block text-sm mb-2 dark:text-white">
        Current password
      </label>
      <div class="relative">
        <input
